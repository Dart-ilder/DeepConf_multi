...
def equal_func(answer: str, ground_truth: str) -> bool:
    ...
    answer = quick_parse(answer) # Removes \text{...} formatting from answer
...
def main():
    ...
    # preprocess helper
    def prepare_prompt_and_ground_truth(data, qid):
    ...
    # Preprocess 1 question or the whole dataset
    if args.qid is not None and len(args.qid) > 0:
        for qid in args.qid:
            prompt, ground_truth, question, qid = prepare_prompt_and_ground_truth(data, qid)
